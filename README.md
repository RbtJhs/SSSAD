...
- TreeAttention
  ...
  ```
- SoftTeacher
  - Our model is initialized on the [SoftTeacher COCO weights](https://cloud.uni-hamburg.de/s/ot2qK4gE6gjwmLE?openfile=true) (alternatavly can be downloaded [here](https://drive.google.com/file/d/1F4ASSqOLwlcyrRIEhQpIl7_f9FdqtwwN/view?usp=sharing), in case main link is broken)
  ```
